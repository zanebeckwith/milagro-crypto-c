...
const BIG Modulus= {0xFFFFFFFF,0xFFFFFF000000000,0xFFFFFFFFFFFFEFF,0xFFFFFFFFFFFFFFF,0xFFFFFFFFFFFFFFF,0xFFFFFFFFFFFFFFF,0xFFFFFF};
const chunk MConst=0x100000001;
const BIG CURVE_Order= {0xCEC196ACCC52973,0x1A0DB248B0A77AE,0x34D81F4372DDF58,0xFFFFFFFFFFFFC76,0xFFFFFFFFFFFFFFF,0xFFFFFFFFFFFFFFF,0xFFFFFF};
const BIG CURVE_B= {0xA85C8EDD3EC2AEF,0x56398D8A2ED19D2,0x4088F5013875AC6,0x9C6EFE814112031,0x56BE3F82D19181D,0xA7E23EE7E4988E0,0xB3312F};
const BIG CURVE_Gx= {0xA545E3872760AB7,0x2F25DBF55296C3,0x741E082542A3855,0x3B628BA79B9859F,0x71EF320AD746E1D,0x22BE8B05378EB1C,0xAA87CA};
const BIG CURVE_Gy= {0xA431D7C90EA0E5F,0x60B1CE1D7E819D7,0xA3113B5F0B8C00A,0x1DBD289A147CE9D,0x8BF9292DC29F8F4,0x4A96262C6F5D9E9,0x3617DE};
#endif
#endif
...
#if CHUNK==64
const BIG Modulus= {0x1FFFFFFFFFFFFFEF,0x1FFFFFFFFFFFFFFF,0x1FFFFFFFFFFFFFFF,0x1FFFFFFFFFFFFFFF,0x1FFFFFFFFFFFFFFF,0x1FFFFFFFFFFFFFFF,0xFFFFFFFFFFFF};
const chunk MConst=0x11;
const BIG CURVE_Order= {0x1B0E71A5E106AF79,0x18E019C56B1E78C0,0x90533DC1808ACDB,0x1FFFFFFFFFD67992,0x1FFFFFFFFFFFFFFF,0x1FFFFFFFFFFFFFFF,0x1FFFFFFFFFFF};
const BIG CURVE_B= {0xE21};
const BIG CURVE_Gx= {0x4FD3812F3CBC595,0xD39FD5429BE326,0x92AD35B5AE8444C,0x7D8FEAFFE6A931,0x6E5FCD46369F44C,0x198010C60318E19,0x68CD24145051};
const BIG CURVE_Gy= {0x22};
#endif
#endif
