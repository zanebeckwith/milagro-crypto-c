...
BUILDS_PF64=LINUX_64BIT_BLS383:-DAMCL_CURVE=BLS383,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPPYTHON} \
	LINUX_64BIT_BN254CX:-DAMCL_CURVE=BN254CX,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPPYTHON} \
	LINUX_64BIT_BN254:-DAMCL_CURVE=BN254,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPPYTHON} \
	LINUX_64BIT_FP256BN:-DAMCL_CURVE=FP256BN,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPPYTHON} \
	LINUX_64BIT_FP512BN:-DAMCL_CURVE=FP512BN,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPPYTHON} \
	LINUX_64BIT_BLS461:-DAMCL_CURVE=BLS461,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPPYTHON} \

BUILDS_NIST64=LINUX_64BIT_NIST256_RSA2048:-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=NIST256,,-DAMCL_RSA=2048 \
	LINUX_64BIT_NIST256_RSA4096:-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=NIST256,,-DAMCL_RSA=4096 \
	LINUX_64BIT_NIST384_RSA3072:-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=NIST384,,-DAMCL_RSA=3072 \
	LINUX_64BIT_NIST521_RSA4096:-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=NIST521,,-DAMCL_RSA=4096 \
...
BUILDS_MISC64=LINUX_64BIT_C25519_RSA2048:-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=C25519,,-DAMCL_RSA=2048 \
	...
	WINDOWS_64BIT_BN254CX:-DAMCL_CURVE=BN254CX,,-DAMCL_RSA=2048,,-DCMAKE_TOOLCHAIN_FILE=../../resources/cmake/mingw64-cross.cmake
...
BUILDS_PF32=LINUX_32BIT_BLS383:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DAMCL_CURVE=BLS383,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl \
	...
	LINUX_32BIT_FP256BN:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DAMCL_CURVE=FP256BN,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl \
	LINUX_32BIT_FP512BN:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DAMCL_CURVE=FP512BN,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl \
	LINUX_32BIT_BLS461:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DAMCL_CURVE=BLS461,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl \
...
BUILDS_ASAN=LINUX_64BIT_BN254CX_ASan:-DCMAKE_BUILD_TYPE=ASan,,-DAMCL_CURVE=BN254CX,,-DAMCL_RSA=2048 \
	LINUX_64BIT_BLS383_ASan:-DCMAKE_BUILD_TYPE=ASan,,-DAMCL_CURVE=BLS383 \
	LINUX_64BIT_BLS455_ASan:-DCMAKE_BUILD_TYPE=ASan,,-DAMCL_CURVE=BLS455 \
	LINUX_64BIT_NIST256_RSA2048_ASan:-DCMAKE_BUILD_TYPE=ASan,,-DAMCL_CURVE=NIST256,,-DAMCL_CURVETYPE=WEIERSTRASS,,-DAMCL_FFLEN=8 \
	LINUX_64BIT_NIST256_RSA4096_ASan:-DCMAKE_BUILD_TYPE=ASan,,-DAMCL_CURVE=NIST256,,-DAMCL_CURVETYPE=WEIERSTRASS,,-DAMCL_FFLEN=16 \
	LINUX_64BIT_NIST384_RSA3072_ASan:-DCMAKE_BUILD_TYPE=ASan,,-DAMCL_CURVE=NIST384,,-DAMCL_CURVETYPE=WEIERSTRASS,,-DAMCL_FFLEN=8 \
	LINUX_64BIT_NIST521_ASan:-DCMAKE_BUILD_TYPE=ASan,,-DAMCL_CURVE=NIST521,,-DAMCL_CURVETYPE=WEIERSTRASS,,-DAMCL_FFLEN=4 \
	LINUX_64BIT_C25519_RSA2048_MONTGOMERY_ASan:-DCMAKE_BUILD_TYPE=ASan,,-DAMCL_CURVE=C25519,,-DAMCL_CURVETYPE=MONTGOMERY,,-DAMCL_FFLEN=8 \
	LINUX_64BIT_C25519_RSA2048_EDWARDS_ASan:-DCMAKE_BUILD_TYPE=ASan,,-DAMCL_CURVE=C25519,,-DAMCL_CURVETYPE=EDWARDS,,-DAMCL_FFLEN=8 \
	LINUX_64BIT_GOLDILOCKS_ASan:-DCMAKE_BUILD_TYPE=ASan,,-DAMCL_CURVE=GOLDILOCKS,,-DAMCL_CURVETYPE=EDWARDS,,-DAMCL_FFLEN=8 \
	LINUX_64BIT_C41417_ASan:-DCMAKE_BUILD_TYPE=ASan,,-DAMCL_CURVE=C41417,,-DAMCL_CURVETYPE=EDWARDS,,-DAMCL_FFLEN=8 
