...
BUILDS_BN32=LINUX_32BIT_BN254_CX_WRAPPERS:-DCMAKE_C_FLAGS=-m32,-DAMCL_CHUNK=32,-DCMAKE_INSTALL_PREFIX=/opt/amcl,${WRAPPERS} \
	LINUX_32BIT_BN254_CX_ANONYMOUS_WRAPPERS:-DCMAKE_C_FLAGS=-m32,-DAMCL_CHUNK=32,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DUSE_ANONYMOUS=on,${WRAPPERS} \
	LINUX_32BIT_BN254_WRAPPERS:-DCMAKE_C_FLAGS=-m32,-DAMCL_CHUNK=32,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN254,${WRAPPERS} \
	LINUX_32BIT_BN254_T_WRAPPERS:-DCMAKE_C_FLAGS=-m32,-DAMCL_CHUNK=32,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN254_T,${WRAPPERS} \
	LINUX_32BIT_BN254_T2_WRAPPERS:-DCMAKE_C_FLAGS=-m32,-DAMCL_CHUNK=32,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN254_T2,${WRAPPERS} \
	LINUX_32BIT_BN454_WRAPPERS:-DCMAKE_C_FLAGS=-m32,-DAMCL_CHUNK=32,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN454,-DAMCL_FFLEN=4,${WRAPPERS} \
	LINUX_32BIT_BN646_WRAPPERS:-DCMAKE_C_FLAGS=-m32,-DAMCL_CHUNK=32,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN646,-DAMCL_FFLEN=4,${WRAPPERS} \
	WINDOWS_32BIT_BN254_CX:-DCMAKE_C_FLAGS=-m32,-DAMCL_CHUNK=32,-DCMAKE_TOOLCHAIN_FILE=../../resources/cmake/mingw32-cross.cmake

BUILDS_BLS32=LINUX_32BIT_BLS383_WRAPPERS:-DCMAKE_C_FLAGS=-m32,-DAMCL_CHUNK=32,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BLS383,${WRAPPERS} \
	LINUX_32BIT_BLS455_WRAPPERS:-DCMAKE_C_FLAGS=-m32,-DAMCL_CHUNK=32,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BLS455,${WRAPPERS}
...
BUILDS_NIST32=LINUX_32BIT_NIST256_RSA2048:-DCMAKE_C_FLAGS=-m32,-DAMCL_CHUNK=32,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=NIST256,-DAMCL_CURVETYPE=WEIERSTRASS,-DAMCL_FFLEN=8 \
	LINUX_64BIT_NIST384:-DCMAKE_C_FLAGS=-m32,-DAMCL_CHUNK=32DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=NIST384,-DAMCL_CURVETYPE=WEIERSTRASS,-DAMCL_FFLEN=4 \
...
#BUILDS_BLS16=LINUX_16BIT_BLS383:-DAMCL_CHUNK=16,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BLS383
...
BUILDS_NIST16=LINUX_16BIT_NIST256:-DAMCL_CHUNK=16,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=NIST256,-DAMCL_CURVETYPE=WEIERSTRASS,-DAMCL_FFLEN=4 
	#LINUX_64BIT_NIST384:-DAMCL_CHUNK=16,DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=NIST384,-DAMCL_CURVETYPE=WEIERSTRASS,-DAMCL_FFLEN=4 \
	#LINUX_16BIT_NIST521:-DAMCL_CHUNK=16,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=NIST521,-DAMCL_CURVETYPE=WEIERSTRASS,-DAMCL_FFLEN=4

BUILDS_MISC16=LINUX_16BIT_C25519_RSA2048_MONTGOMERY:-DAMCL_CHUNK=16,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=C25519,-DAMCL_CURVETYPE=MONTGOMERY,-DAMCL_FFLEN=8 
	#LINUX_16BIT_C25519_EDWARDS:-DAMCL_CHUNK=16,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=C25519,-DAMCL_CURVETYPE=EDWARDS,-DAMCL_FFLEN=4\
	#LINUX_16BIT_GOLDILOCKS:-DAMCL_CHUNK=16,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=GOLDILOCKS,-DAMCL_CURVETYPE=EDWARDS,-DAMCL_FFLEN=4\
	#LINUX_16BIT_C41417:-DAMCL_CHUNK=16,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=C41417,-DAMCL_CURVETYPE=EDWARDS,-DAMCL_FFLEN=4
...
BUILDS_COVERAGE=LINUX_64BIT_BN254_CX_Coverage:-DCMAKE_BUILD_TYPE=Coverage \
	LINUX_64BIT_BLS383_Coverage:-DCMAKE_BUILD_TYPE=Coverage,-DAMCL_CHOICE=BLS383 \
	LINUX_64BIT_BLS455_Coverage:-DCMAKE_BUILD_TYPE=Coverage,-DAMCL_CHOICE=BLS455 \
	LINUX_64BIT_NIST256_RSA2048_Coverage:-DCMAKE_BUILD_TYPE=Coverage,-DAMCL_CHOICE=NIST256,-DAMCL_CURVETYPE=WEIERSTRASS,-DAMCL_FFLEN=8 \
	LINUX_64BIT_NIST256_RSA4096_Coverage:-DCMAKE_BUILD_TYPE=Coverage,-DAMCL_CHOICE=NIST256,-DAMCL_CURVETYPE=WEIERSTRASS,-DAMCL_FFLEN=16 \
	LINUX_64BIT_NIST384_RSA3072_Coverage:-DCMAKE_BUILD_TYPE=Coverage,-DAMCL_CHOICE=NIST384,-DAMCL_CURVETYPE=WEIERSTRASS,-DAMCL_FFLEN=8 \
	LINUX_64BIT_NIST521_Coverage:-DCMAKE_BUILD_TYPE=Coverage,-DAMCL_CHOICE=NIST521,-DAMCL_CURVETYPE=WEIERSTRASS,-DAMCL_FFLEN=4 \
	LINUX_64BIT_C25519_RSA2048_MONTGOMERY_Coverage:-DCMAKE_BUILD_TYPE=Coverage,-DAMCL_CHOICE=C25519,-DAMCL_CURVETYPE=MONTGOMERY,-DAMCL_FFLEN=8 \
	LINUX_64BIT_C25519_RSA2048_EDWARDS_Coverage:-DCMAKE_BUILD_TYPE=Coverage,-DAMCL_CHOICE=C25519,-DAMCL_CURVETYPE=EDWARDS,-DAMCL_FFLEN=8 \
	LINUX_64BIT_GOLDILOCKS_Coverage:-DCMAKE_BUILD_TYPE=Coverage,-DAMCL_CHOICE=GOLDILOCKS,-DAMCL_CURVETYPE=EDWARDS,-DAMCL_FFLEN=8 \
	LINUX_64BIT_C41417_Coverage:-DCMAKE_BUILD_TYPE=Coverage,-DAMCL_CHOICE=C41417,-DAMCL_CURVETYPE=EDWARDS,-DAMCL_FFLEN=8 
