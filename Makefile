...
BUILDS_PF64=LINUX_64BIT_BLS383:-DAMCL_CURVE=BLS383,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG},,${WRAPPYTHON} \
	...
	LINUX_64BIT_ALLPF_DVS:-DAMCL_CURVE=BN254,BN254CX,BLS383,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG}
...
BUILDS_PF32=LINUX_32BIT_BLS383:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DAMCL_CURVE=BLS383,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG},,${WRAPPYTHON} \
	...
	LINUX_32BIT_ALLPF_DVS:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DAMCL_CURVE=BN254,BN254CX,BLS383,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG}
