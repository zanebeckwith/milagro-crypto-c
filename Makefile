...
BUILDS_PF64=LINUX_64BIT_BLS383:-DAMCL_CURVE=BLS383,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG},,${WRAPPYTHON} \
	...
	LINUX_64BIT_BN254CX_DVS:-DAMCL_CURVE=BN254CX,,-DAMCL_RSA=2048,,-DUSE_DVS=on,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG} \
	LINUX_64BIT_ALLPF:-DAMCL_CURVE=BN254,BN254CX,BLS383,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG},,${WRAPPYTHON} \
	LINUX_64BIT_ALLPF_DVS:-DAMCL_CURVE=BN254,BN254CX,BLS383,,-DAMCL_RSA=2048,,-DUSE_DVS=on,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG}
...
BUILDS_MISC64=LINUX_64BIT_C25519_RSA2048:-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=C25519,,-DAMCL_RSA=2048,,${WRAPGOLANG} \
	...
	LINUX_64BIT_C25519_BN254CX_RSA2048:-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=C25519,BN254CX,,-DAMCL_RSA=2048,,${WRAPGOLANG} \
	LINUX_64BIT_NIST256_BN254CX_RSA2048:-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=NIST256,BN254CX,,-DAMCL_RSA=2048,,${WRAPGOLANG}
	

BUILDS_PF32=LINUX_32BIT_BLS383:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DAMCL_CURVE=BLS383,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG},,${WRAPPYTHON} \
	LINUX_32BIT_BN254CX:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DAMCL_CURVE=BN254CX,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG},,${WRAPPYTHON} \
	LINUX_32BIT_BN254:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DAMCL_CURVE=BN254,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG},,${WRAPPYTHON} \
	LINUX_32BIT_BN254CX_DVS:$-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DAMCL_CURVE=BN254CX,,-DAMCL_RSA=2048,,-DUSE_DVS=on,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG} \
	LINUX_32BIT_ALLPF:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DAMCL_CURVE=BN254,BN254CX,BLS383,,-DAMCL_RSA=2048,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG},,${WRAPPYTHON} \
	LINUX_32BIT_ALLPF_DVS:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DAMCL_CURVE=BN254,BN254CX,BLS383,,-DAMCL_RSA=2048,,-DUSE_DVS=on,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,${WRAPGOLANG}

BUILDS_NIST32=LINUX_32BIT_NIST256_RSA2048:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=NIST256,,-DAMCL_RSA=2048,,${WRAPGOLANG} \
	LINUX_32BIT_NIST256_RSA4096:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=NIST256,,-DAMCL_RSA=4096,,${WRAPGOLANG} \
	LINUX_32BIT_NIST384_RSA3072:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=NIST384,,-DAMCL_RSA=3072,,${WRAPGOLANG} \
	LINUX_32BIT_NIST521_RSA4096:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=NIST521,,-DAMCL_RSA=4096,,${WRAPGOLANG} \
...
BUILDS_MISC32=LINUX_32BIT_C25519_RSA2048:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=C25519,,-DAMCL_RSA=2048,,${WRAPGOLANG} \
	...
	LINUX_32BIT_C25519_BN254CX_RSA2048:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=C25519,BN254CX,,-DAMCL_RSA=2048,,${WRAPGOLANG} \
	LINUX_32BIT_NIST256_BN254CX_RSA2048:-DCMAKE_C_FLAGS=-m32,,-DAMCL_CHUNK=32,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=NIST256,BN254CX,,-DAMCL_RSA=2048,,${WRAPGOLANG}
...
BUILDS_NIST16=LINUX_16BIT_NIST256:-DAMCL_CHUNK=16,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=NIST256,,-DAMCL_RSA=2048 

BUILDS_MISC16=LINUX_16BIT_C25519:-DAMCL_CHUNK=16,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=C25519 \
	LINUX_16BIT_ED25519:-DAMCL_CHUNK=16,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=ED25519 \
	LINUX_16BIT_NUMS256E:-DAMCL_CHUNK=16,,-DCMAKE_INSTALL_PREFIX=/opt/amcl,,-DAMCL_CURVE=NUMS256E

BUILDS_ASAN=LINUX_64BIT_ASan:-DCMAKE_BUILD_TYPE=ASan,,-DAMCL_CURVE=NIST256,C25519,ED25519,BRAINPOOL,ANSSI,NUMS256E,NUMS256W,NUMS384E,NUMS384W,NUMS512E,NUMS512W,HIFIVE,GOLDILOCKS,NIST384,C41417,NIST521,BN254,BN254CX,BLS383,,-DAMCL_RSA=2048,3072,4096,,-DUSE_DVS=on \

BUILDS_COVERAGE=LINUX_64BIT_COVERAGE:-DCMAKE_BUILD_TYPE=Coverage,,-DAMCL_CURVE=NIST256,BN254CX,,-DAMCL_RSA=2048,,-DUSE_DVS=on
...
BUILDS_16=$(BUILDS_BN16) $(BUILDS_NIST16) $(BUILDS_MISC16)
