...
BUILDS=ASAN:-DCMAKE_BUILD_TYPE=ASan,-DAMCL_CHUNK=64,-DBUILD_WCC=on \
	...
	LINUX_64BIT_BLS455:-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHUNK=64,-DAMCL_CHOICE=BLS455,-DAMCL_CURVETYPE=WEIERSTRASS,-DAMCL_FFLEN=4,-DBUILD_PYTHON=on,-DBUILD_GO=on,-DGO_PATH=${GOPATH}
