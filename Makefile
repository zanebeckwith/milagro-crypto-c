...
# Space-separated list of build options:
...
BUILDS=ASAN:-DCMAKE_BUILD_TYPE=ASan,-DBUILD_WCC=on \
	...
	LINUX_64BIT_BN454_WRAPPERS:-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN454,-DAMCL_FFLEN=2,${WRAPPERS} \
	LINUX_64BIT_BN646_WRAPPERS:-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN646,-DAMCL_FFLEN=2,${WRAPPERS} \
	...
	LINUX_32BIT_BN454:-DCMAKE_C_FLAGS=-m32,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN454,-DAMCL_FFLEN=2,-DAMCL_CHUNK=32 \
	LINUX_32BIT_BN646:-DCMAKE_C_FLAGS=-m32,-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN646,-DAMCL_FFLEN=2,-DAMCL_CHUNK=32 \
