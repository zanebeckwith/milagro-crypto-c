...
BUILDS=ASAN:-DCMAKE_BUILD_TYPE=ASan,-DBUILD_WCC=on \
	...
	LINUX_64BIT_BN254_CX_ANONYMOUS:-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DUSE_ANONYMOUS=on,${WRAPPERS} \
	LINUX_64BIT_BN254_CX:-DCMAKE_INSTALL_PREFIX=/opt/amcl,${WRAPPERS} \
	LINUX_64BIT_BN454:-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN454,-DFFLEN=2,${WRAPPERS} \
	LINUX_64BIT_BN646:-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN646,-DFFLEN=2,${WRAPPERS} \
	LINUX_64BIT_BN254:-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN254,${WRAPPERS} \
	LINUX_64BIT_BN254_T:-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN254_T,${WRAPPERS} \
	LINUX_64BIT_BN254_T2:-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN254_T2,${WRAPPERS} \
	LINUX_64BIT_BLS455:-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BLS455,${WRAPPERS}  \
