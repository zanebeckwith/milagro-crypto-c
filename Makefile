...
BUILDS=ASAN:-DCMAKE_BUILD_TYPE=ASan,-DBUILD_WCC=on \
	...
	LINUX_64BIT_BN454_WRAPPERS:-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN454,-DFFLEN=2,${WRAPPERS} \
	LINUX_64BIT_BN646_WRAPPERS:-DCMAKE_INSTALL_PREFIX=/opt/amcl,-DAMCL_CHOICE=BN646,-DFFLEN=2,${WRAPPERS} \
