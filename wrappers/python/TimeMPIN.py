...
if __name__ == "__main__":
    ...
    time_func('rtn, tp1 = mpin.get_client_permit(date, ms1, hash_mpin_id)', nIter)
    ...
    PIN = 1234
    time_func('rtn, token = mpin.extract_pin(mpin_id, PIN, client_secret)', nIter)
    ...
    if ONE_PASS:
        ...
        # Client MPIN
        time_func('rtn, x, u, ut, v, y = mpin.client(date, mpin_id, rng, None, PIN, token, time_permit, None, epoch_time)', nIter)
        ...
        # Server MPIN
        time_func('rtn, HID, HTID, E, F, y2 = mpin.server(date, server_secret, u, ut, v, pID, None, epoch_time)', nIter)
        ...
        if MPIN_FULL:
            ...
            time_func('rtn, client_aes_key = mpin.client_key(pc1, pc2, PIN, r, x, HM, T)', nIter)
            ...
            time_func('rtn, server_aes_key = mpin.server_key(Z, server_secret, w, HM, HID, u, ut)', nIter)
        ...
        # Client first pass
        time_func('rtn, x, u, ut, sec = mpin.client_1(date, mpin_id, rng, None, PIN, token, time_permit)', nIter)
