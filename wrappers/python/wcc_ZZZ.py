...
extern int WCC_ZZZ_GET_G2_MULTIPLE(int sha, int hashDone,octet *S,octet *ID,octet *VG2);
extern int WCC_ZZZ_GET_G1_MULTIPLE(int sha, int hashDone,octet *S,octet *ID,octet *VG1);
extern int WCC_ZZZ_GET_G1_TPMULT(int sha, int date, octet *S,octet *ID,octet *VG1);
extern int WCC_ZZZ_GET_G2_TPMULT(int sha, int date, octet *S,octet *ID,octet *VG2);
extern int WCC_ZZZ_GET_G1_PERMIT(int sha, int date,octet *S,octet *HID,octet *G1TP);
extern int WCC_ZZZ_GET_G2_PERMIT(int sha, int date,octet *S,octet *HID,octet *G2TP);
extern int WCC_ZZZ_SENDER_KEY(int sha, int date, octet *xOct, octet *piaOct, octet *pibOct, octet *PbG2Oct, octet *PgG1Oct, octet *AKeyG1Oct, octet *ATPG1Oct, octet *IdBOct, octet *AESKeyOct);
extern int WCC_ZZZ_RECEIVER_KEY(int sha, int date, octet *yOct, octet *wOct,  octet *piaOct, octet *pibOct,  octet *PaG1Oct, octet *PgG1Oct, octet *BKeyG2Oct,octet *BTPG2Oct,  octet *IdAOct, octet *AESKeyOct);
...
if __name__ == "__main__":
    ...
    rtn = libamcl_wcc_ZZZ.WCC_ZZZ_RECOMBINE_G1(A1TPG1, A2TPG1, ATPG1)
    if rtn != 0:
        print "libamcl_wcc_ZZZ.WCC_ZZZ_RECOMBINE_G1(A1TPG1, A2TPG1, ATPG1) Error %s" % rtn
    ...
    rtn = libamcl_wcc_ZZZ.WCC_ZZZ_RECOMBINE_G2(B1TPG2, B2TPG2, BTPG2)
    if rtn != 0:
        print "libamcl_wcc_ZZZ.WCC_ZZZ_RECOMBINE_G2(B1TPG2, B2TPG2, BTPG2) Error %s" % rtn
