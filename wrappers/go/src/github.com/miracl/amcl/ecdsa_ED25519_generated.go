...
func ECPKeyPairGenerate_ED25519(RNG *Rand, S []byte) (int, []byte, []byte) {
...
func ECPSpDsa_ED25519(hashType int, RNG *Rand, K []byte, S []byte, M []byte) (errorCode int, C []byte, D []byte) {
	KStr := string(K)
	KOct := GetOctet(KStr)
