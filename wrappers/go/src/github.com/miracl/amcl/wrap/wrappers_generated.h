...
extern int _MPIN_BLS383_GET_G1_MULTIPLE(csprng *R, int t, octet x, octet G, octet W);
extern int _MPIN_BN254_GET_G1_MULTIPLE(csprng *R, int t, octet x, octet G, octet W);
extern int _MPIN_BN254CX_GET_G1_MULTIPLE(csprng *R, int t, octet x, octet G, octet W);
