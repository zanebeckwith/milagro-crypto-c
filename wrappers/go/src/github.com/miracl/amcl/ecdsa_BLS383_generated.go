...
func ECPKeyPairGenerate_BLS383(RNG *RandNG, S []byte) (int, []byte, []byte) {
...
func ECPSpDsa_BLS383(hashType int, RNG *RandNG, K []byte, S []byte, M []byte) (errorCode int, C []byte, D []byte) {
	KStr := string(K)
	KOct := GetOctet(KStr)
