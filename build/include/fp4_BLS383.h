...
typedef struct
{
    FP2_BLS383 a /**< real part of FP4 */
    FP2_BLS383 b /**< imaginary part of FP4 */
} FP4_BLS383
 ...
 */
extern int FP4_BLS383_iszilch(FP4_BLS383 *x)
/**	@brief Tests for FP4 equal to unity
 *
	@param x FP4 number to be tested
	@return 1 if unity, else returns 0
 */
extern int FP4_BLS383_isunity(FP4_BLS383 *x)
 ...
 */
extern void FP4_BLS383_from_FP2s(FP4_BLS383 *x,FP2_BLS383 *a,FP2_BLS383 *b)
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS383_conj(FP4_BLS383 *x,FP4_BLS383 *y)
 ...
 *
	...
	@param y FP4 instance
 */
extern void FP4_BLS383_nconj(FP4_BLS383 *x,FP4_BLS383 *y)
 ...
 */
extern void FP4_BLS383_add(FP4_BLS383 *x,FP4_BLS383 *y,FP4_BLS383 *z)
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS383_sub(FP4_BLS383 *x,FP4_BLS383 *y,FP4_BLS383 *z)
 ...
 */
extern void FP4_BLS383_pmul(FP4_BLS383 *x,FP4_BLS383 *y,FP2_BLS383 *a)
 ...
 *
	...
	@param i an integer
 */
extern void FP4_BLS383_imul(FP4_BLS383 *x,FP4_BLS383 *y,int i)
/**	@brief Squaring an FP4
 *
	@param x FP4 instance, on exit = y^2
	@param y FP4 instance
 */
extern void FP4_BLS383_sqr(FP4_BLS383 *x,FP4_BLS383 *y)
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS383_pow(FP4_BLS383 *x,FP4_BLS383 *y,BIG_384_56 b)
/**	@brief Raises an FP4 to the power of the internal modulus p, using the Frobenius
 *
	@param x FP4 instance, on exit = x^p
	@param f FP2 precalculated Frobenius constant
 */
extern void FP4_BLS383_frob(FP4_BLS383 *x,FP2_BLS383 *f)
 ...
 *
	...
	@param z FP4 instance
 */
extern void FP4_BLS383_xtr_A(FP4_BLS383 *r,FP4_BLS383 *w,FP4_BLS383 *x,FP4_BLS383 *y,FP4_BLS383 *z)
/**	@brief Calculates the XTR doubling function r=x^2-2*conj(x)
 *
	@param r FP4 instance, on exit = x^2-2*conj(x)
	@param x FP4 instance
 */
extern void FP4_BLS383_xtr_D(FP4_BLS383 *r,FP4_BLS383 *x)
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS383_xtr_pow(FP4_BLS383 *r,FP4_BLS383 *x,BIG_384_56 b)
 ...
 *
	...
	@param b BIG number
 */
extern void FP4_BLS383_xtr_pow2(FP4_BLS383 *r,FP4_BLS383 *c,FP4_BLS383 *d,FP4_BLS383 *e,FP4_BLS383 *f,BIG_384_56 a,BIG_384_56 b)
