#ifndef FP12_BLS383_H
#define FP12_BLS383_H

#include "fp4_BLS383.h"
...
typedef struct
{
    FP4_BLS383 a /**< first part of FP12 */
    FP4_BLS383 b /**< second part of FP12 */
    FP4_BLS383 c /**< third part of FP12 */
} FP12_BLS383

extern const BIG_384_56 Fra_BLS383 /**< real part of BN curve Frobenius Constant */
extern const BIG_384_56 Frb_BLS383 /**< imaginary part of BN curve Frobenius Constant */
 ...
 */
extern int FP12_BLS383_equals(FP12_BLS383 *x,FP12_BLS383 *y)
 ...
 */
extern void FP12_BLS383_conj(FP12_BLS383 *x,FP12_BLS383 *y)
 ...
 */
extern void FP12_BLS383_from_FP4(FP12_BLS383 *x,FP4_BLS383 *a)
 ...
 */
extern void FP12_BLS383_from_FP4s(FP12_BLS383 *x,FP4_BLS383 *a,FP4_BLS383* b,FP4_BLS383 *c)
/**	@brief Fast Squaring of an FP12 in "unitary" form
 *
	@param x FP12 instance, on exit = y^2
	@param y FP4 instance, must be unitary
 */
extern void FP12_BLS383_usqr(FP12_BLS383 *x,FP12_BLS383 *y)
/**	@brief Squaring an FP12
 *
	@param x FP12 instance, on exit = y^2
	@param y FP12 instance
 */
extern void FP12_BLS383_sqr(FP12_BLS383 *x,FP12_BLS383 *y)
 ...
 */
extern void FP12_BLS383_smul(FP12_BLS383 *x,FP12_BLS383 *y)
/**	@brief Multiplication of two FP12s
 *
	@param x FP12 instance, on exit = x*y
	@param y FP12 instance, the multiplier
 */
extern void FP12_BLS383_mul(FP12_BLS383 *x,FP12_BLS383 *y)
/**	@brief Inverting an FP12
 *
	@param x FP12 instance, on exit = 1/y
	@param y FP12 instance
 */
extern void FP12_BLS383_inv(FP12_BLS383 *x,FP12_BLS383 *y)
 ...
 *
	...
	@param b BIG number
 */
extern void FP12_BLS383_pow(FP12_BLS383 *r,FP12_BLS383 *x,BIG_384_56 b)
 ...
 */
extern void FP12_BLS383_pinpow(FP12_BLS383 *x,int i,int b)
 ...
 */
extern void FP12_BLS383_compow(FP4_BLS383 *c,FP12_BLS383 *x,BIG_384_56 e,BIG_384_56 r)
 ...
 */
extern void FP12_BLS383_toOctet(octet *S,FP12_BLS383 *x)
 ...
 */
extern void FP12_BLS383_fromOctet(FP12_BLS383 *x,octet *S)
 ...
 */
extern void FP12_BLS383_trace(FP4_BLS383 *t,FP12_BLS383 *x)
