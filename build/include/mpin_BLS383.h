...
#ifndef MPIN_BLS383_H
#define MPIN_BLS383_H
...
#define PGS_BLS383 MODBYTES_384_56  /**< MPIN Group Size */
#define PFS_BLS383 MODBYTES_384_56  /**< MPIN Field Size */
#define PAS_BLS383 16        /**< MPIN Symmetric Key Size */
...
#define MAXPIN_BLS383 10000         /**< max PIN */
#define PBLEN_BLS383 14             /**< max length of PIN in bits */

#define HASH_TYPE_MPIN_BLS383 SHA256   /**< Choose Hash function */
...
void MPIN_BLS383_GET_Y(int h,int t,octet *O,octet *Y)
 ...
 */
int MPIN_BLS383_EXTRACT_PIN(int h,octet *ID,int pin,octet *CS)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_CLIENT(int h,int d,octet *ID,csprng *R,octet *x,int pin,octet *T,octet *V,octet *U,octet *UT,octet *TP, /*octet* MESSAGE,*/ int t, octet *y)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_CLIENT_1(int h,int d,octet *ID,csprng *R,octet *x,int pin,octet *T,octet *S,octet *U,octet *UT,octet *TP)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_RANDOM_GENERATE(csprng *R,octet *S)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_CLIENT_2(octet *x,octet *y,octet *V)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_SERVER(int h,int d,octet *HID,octet *HTID,octet *y,octet *SS,octet *U,octet *UT,octet *V,octet *E,octet *F,octet *ID,/*octet *MESSAGE,*/ int t)
 ...
 *
	...
	@return 0 or an error code
 */
void MPIN_BLS383_SERVER_1(int h,int d,octet *ID,octet *HID,octet *HTID)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_SERVER_2(int d,octet *HID,octet *HTID,octet *y,octet *SS,octet *U,octet *UT,octet *V,octet *E,octet *F)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_RECOMBINE_G1(octet *Q1,octet *Q2,octet *Q)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_RECOMBINE_G2(octet *P1,octet *P2,octet *P)
 ...
 */
int MPIN_BLS383_KANGAROO(octet *E,octet *F)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_GET_G1_MULTIPLE(csprng *R,int type,octet *x,octet *G,octet *W)
/**	@brief Find a random multiple of a point in G1
 *
	@param R is a pointer to a cryptographically secure random number generator
	...
	@return 0 or an error code
 */
int MPIN_BLS383_GET_G2_MULTIPLE(csprng *R,int type,octet *x,octet *G,octet *W)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_GET_CLIENT_SECRET(octet *S,octet *ID,octet *CS)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_GET_CLIENT_PERMIT(int h,int d,octet *S,octet *ID,octet *TP)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_GET_SERVER_SECRET(octet *S,octet *SS)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_PRECOMPUTE(octet *T,octet *ID,octet *CP,octet *g1,octet *g2)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_SERVER_KEY(int h,octet *Z,octet *SS,octet *w,octet *p,octet *I,octet *U,octet *UT,octet *K)
 ...
 *
	...
	@return 0 or an error code
 */
int MPIN_BLS383_CLIENT_KEY(int h,octet *g1,octet *g2,int pin,octet *r,octet *x,octet *p,octet *T,octet *K)
