...
#ifndef ECDH_BLS383_H
#define ECDH_BLS383_H
...
#define EAS_BLS383 16 /**< Symmetric Key size - 128 bits */
#define HASH_TYPE_ECC_BLS383 SHA512  /**< Hash type */

/*** END OF USER CONFIGURABLE SECTION ***/

#define EGS_BLS383 MODBYTES_384_56  /**< ECC Group Size in bytes */
#define EFS_BLS383 MODBYTES_384_56  /**< ECC Field Size in bytes */
 ...
 */
extern int  ECP_BLS383_KEY_PAIR_GENERATE(csprng *R,octet *s,octet *W)
 ...
 */
extern int  ECP_BLS383_PUBLIC_KEY_VALIDATE(octet *W)
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_BLS383_SVDP_DH(octet *s,octet *W,octet *K)
 ...
 */
extern void ECP_BLS383_ECIES_ENCRYPT(int h,octet *P1,octet *P2,csprng *R,octet *W,octet *M,int len,octet *V,octet *C,octet *T)
 ...
 */
extern int ECP_BLS383_ECIES_DECRYPT(int h,octet *P1,octet *P2,octet *V,octet *C,octet *T,octet *U,octet *M)
 ...
 */
extern int ECP_BLS383_SP_DSA(int h,csprng *R,octet *k,octet *s,octet *M,octet *c,octet *d)
 ...
 *
	...
	@return 0 or an error code
 */
extern int ECP_BLS383_VP_DSA(int h,octet *W,octet *M,octet *c,octet *d)
/*#endif*/
