...
typedef struct
{
    BIG_384_56 g	/**< Big representation of field element */
    sign32 XES	/**< Excess */
} FP_BLS383


/* Field Params - see rom.c */
extern const BIG_384_56 Modulus_BLS383	/**< Actual Modulus set in romf_yyy.c */
extern const BIG_384_56 R2modp_BLS383	/**< Montgomery constant */
extern const chunk MConst_BLS383		/**< Constant associated with Modulus - for Montgomery = 1/p mod 2^BASEBITS */


#define MODBITS_BLS383 MBITS_BLS383
#define TBITS_BLS383 (MBITS_BLS383%BASEBITS_384_56)                    /**< Number of active bits in top word */
 ...
 */
extern void FP_BLS383_rcopy(FP_BLS383 *y,const BIG_384_56 x)
 ...
 *
	...
	@param y FP result
 */
extern void FP_BLS383_nres(FP_BLS383 *y,BIG_384_56 x)
/**	@brief Converts from residue form back to BIG integer form
 *
	@param y FP number to be converted to BIG
	@param x BIG result
 */
extern void FP_BLS383_redc(BIG_384_56 x,FP_BLS383 *y)
 ...
 */
extern void FP_BLS383_mod(BIG_384_56 r,DBIG_384_56 d)

#ifdef FUSED_MODMUL
extern void FP_BLS383_modmul(BIG_384_56,BIG_384_56,BIG_384_56)
#endif
 ...
 */
extern void FP_BLS383_pow(FP_BLS383 *x,FP_BLS383 *y,BIG_384_56 z)
